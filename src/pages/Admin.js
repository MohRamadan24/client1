    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <div class="flex md:order-2 ">
            <button data-collapse-toggle="navbar-search" type="button" class="mx-3 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg xl:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
...
{/* <aside id="logo-sidebar" class="fixed top-0 right-0 z-30 w-64 h-screen pt-5 pb-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <a href="https://flowbite.com/" class="flex items-center mb-5 px-5 h-12">
      <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3 sm:h-10" alt="Flowbite Logo" />
      <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-white">Flowbite</span>
   </a>
...
{/* <div class="flex flex-col min-[900px]:flex-row flex-wrap xl:ml-64">
   <div class="p-5 border-2 w-full min-[900px]:max-w-[calc(100%-455px)] border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-[88px]">
      <div class="grid grid-cols-3 gap-4 mb-4 ">
         ...
         <div class="col-span-2 flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
   ...
   <div class="p-5 border-2 w-full min-w-[455px] min-[900px]:max-w-[455px] border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-[88px]">
